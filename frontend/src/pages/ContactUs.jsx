              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:contact@swiftcart.com"
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                answer:
                  "Yes, you can reach our support team at +254 (707) 435-237 during business hours.",
              },
            ].map((item, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-950 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200"
              >
