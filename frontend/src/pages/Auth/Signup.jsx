        ...
        <div className='bg-white w-80 md:w-96 h-[30rem]'>
            ...
            <form action="" method="post" className='w-full h-full flex flex-col justify-around'>
                <div className='w-full'>
                    <h1 className='text-2xl font-bold pl-5'>Sign Up</h1>
                ...
                <div className='w-full flex flex-col items-center'>
                    <label htmlFor="email" className='w-[90%] font-medium'>Email</label>
                ...
                <div className='w-full flex flex-col items-center'>
                    <label htmlFor="password" className='w-[90%] font-medium'>Password</label>
                    <input type="email" className='w-[90%] bg-gray-200 h-10 pl-3 outline-0 text-gray-800 rounded-md'
                    required placeholder='Enter your password'/>
                </div>

                 <div className='w-full flex flex-col items-center'>
                    <label htmlFor="password" className='w-[90%] font-medium'>Confirm Password</label>
                    <input type="email" className='w-[90%] bg-gray-200 h-10 pl-3 outline-0 text-gray-800 rounded-md'
                ...
                <div className='w-full flex flex-col items-center'>
                    ...
                    <div className='w-[90%] bg-gray-200 h-10 pl-3 rounded-lg flex justify-center items-center cursor-pointer'>
