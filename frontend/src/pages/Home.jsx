      ...
      <div className='flex flex-col items-center w-full min-h-screen bg-gray-300 dark:bg-gray-700'>
        ...
        <div className='flex flex-col items-center mt-3'>
          ...
          <div className=' w-[90vw] flex justify-between mb-5 items-center'>
            <p className='text-sm font-bold sm:text-base lg:text-xl'>Beauty & Skincare</p>
          ...
          {beautyProducts.length < 1? <LoadingSkeleton length={8} />: <GridProducts items={beautyProducts} />} 
        ...
        <div className='flex flex-col items-center w-full mt-5 mb-5'>
          <div className=' w-[90vw] flex justify-between mb-5 items-center'>
            <p className='text-sm font-bold sm:text-base lg:text-xl'>Fashion & Accessories</p>
            <button className='flex items-center px-2 py-1 text-sm text-black bg-white rounded-md'>View all <ArrowRight className='w-4 h-4'/></button>
          </div>
          {fashionProducts.length < 1? <LoadingSkeleton length={8} /> : <GridProducts items={fashionProducts} />}
        </div>
        ...
        <div className='flex justify-center w-full mt-5 mb-5 '>
            <div className='w-[95vw] sm:w-[90vw] h-24 bg-gradient-to-r from-amber-800 to-amber-400 rounded-2xl pl-3 pt-2'>
              <h1 className='text-sm font-bold text-green-900 sm:text-base lg:text-2xl'>In store or online, your health & safety is our top priority</h1>
              <p className='pt-3 text-xs text-white md:text-base'>The only store that makes your life easier, makes you enjoy life and makes it better.</p>
            </div>
        </div>
        ...
        <div className='flex flex-col items-center w-full mt-5 mb-5'>
          <div className=' w-[90vw] flex justify-between mb-5 items-center'>
            <p className='text-sm font-bold sm:text-base lg:text-xl'>Furniture & Home Accessories</p>
            <button className='flex items-center px-2 py-1 text-sm text-black bg-white rounded-md'>View all <ArrowRight className='w-4 h-4'/></button>
          </div>
          {homeProducts.length < 1 ?<LoadingSkeleton length={8} /> : <GridProducts items={homeProducts} />}
        </div>
