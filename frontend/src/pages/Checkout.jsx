    ...
    <div className="min-h-screen p-4 bg-gray-100 md:p-8 dark:bg-gray-800">
      <div className="grid max-w-5xl grid-cols-1 gap-8 p-6 mx-auto bg-white shadow-md dark:bg-gray-950 rounded-xl md:grid-cols-2">
        ...
        <div className="space-y-4">
          ...
          <input value={user.email} readOnly placeholder="Email Address" type="email" className="w-full p-2 border rounded outline-none" />
          <input value={address.country} readOnly placeholder="Country" className="w-full p-2 border rounded outline-none" />
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <input value={address.city} readOnly placeholder="State / County" className="w-full p-2 border rounded" />
            <input value={address.postalCode} readOnly placeholder="Zip / Postal Code" className="w-full p-2 border rounded" />
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col">
                <div className="relative flex items-center gap-2">
                  ...
                  className='absolute left-4'/>
                  <label htmlFor="mpesa" className='flex items-center justify-between w-full pl-8 pr-2 bg-gray-200 border rounded-md dark:bg-gray-800'>
                    M-Pesa
