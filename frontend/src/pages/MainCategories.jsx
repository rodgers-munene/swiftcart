  ...
  useEffect(() => {
    try {
      const getData = async () => {
        ...
        const mobileAccessoriesData = await getProductsInCategory(
          "mobile-accessories",
          4
        );
  ...
  return (
    <div className="w-screen">
      <div className="flex flex-col items-center w-full h-auto">
        ...
        <div
          className={`bg-white border dark:bg-gray-950 rounded-xl shadow pl-4 pt-1 pb-1 h-52 overflow-y-auto md:overflow-y-hidden w-full md:w-[95%] ${
      ...
      <div className="mt-5">
        {topCategories.map((item, index) => (
          <div key={index} className="flex flex-col items-center mt-3 mb-5">
