    ...
    <div className='w-screen min-h-[80vh] flex flex-col items-center'>
      ...
      <div className='flex w-[90%] flex-wrap justify-around h-auto border-b-2 border-gray-400 dark:border-gray-50 py-10'>
        ...
        <div className='w-[200px] md:w-[300px] mt-5 '>
          ...
          <div className='flex flex-col pl-2'>
            <a href="" className='py-1 text-xs md:text-base'>Sell on SwiftCart</a>
            <a href="" className='py-1 text-xs md:text-base'>Become an affiliate</a>
            <a href="" className='py-1 text-xs md:text-base'>Advertise with us</a>
            <a href="" className='py-1 text-xs md:text-base'>Sell-publish with us</a>
            <a href="" className='py-1 text-xs md:text-base'>Become a vendor</a>
          </div>
        </div>
        <div className='w-[200px] md:w-[300px] mt-5'>
            <h1 className='text-sm md:text-xl font-bold'>Let us help you</h1>
            <div className='flex flex-col pl-2'>
              <a href="" className='py-1 text-xs md:text-base'>Accessibility statement</a>
              <a href="" className='py-1 text-xs md:text-base'>Your orders</a>
              <a href="" className='py-1 text-xs md:text-base'>Shipping rates and policies</a>
              <a href="" className='py-1 text-xs md:text-base'>Refund and return policy</a>
              <a href="" className='py-1 text-xs md:text-base'>Privacy policy</a>
              <a href="" className='py-1 text-xs md:text-base'>Terms and Conditions</a>
            </div>
        </div>
        <div className='w-[200px] md:w-[300px] mt-5'>
            <h1 className='text-sm md:text-xl font-bold'>Get to know us</h1>
            <div className='flex flex-col pl-2'>
              <a href="" className='py-1 text-xs md:text-base'>Careers for SwiftCart</a>
              <a href="" className='py-1 text-xs md:text-base'>About Swiftcart</a>
              <a href="" className='py-1 text-xs md:text-base'>Investor Relations</a>
              <a href="" className='py-1 text-xs md:text-base'>Customer Relations</a>
              <a href="" className='py-1 text-xs md:text-base'>Store locations</a>
            </div>
        </div>
      ...
      <div className='flex flex-col items-center sm:flex-row justify-around w-[90%] pt-2'>
        ...
        <div className='mt-3 sm:mt-0'>
          <p className='text-xs md:text-base'>Copyright @2025 SwiftCart Store. All rights reserved. </p>
        </div>
      </div>
